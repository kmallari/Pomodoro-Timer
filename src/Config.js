  ...
  return (
    <div className="flex flex-col content-center">
      ...
      <div className="flex items-center justify-center">
        <button id="start_stop" onClick={handleStartStop} className="text-4xl text-gray-600 shadow-xl m-4 p-2 rounded-xl transition-all hover:bg-blue-600 hover:text-white">
          {!started ? <TiMediaPlayOutline /> : <TiMediaPauseOutline />}
        </button>
        <button id="reset" onClick={handleReset} className="text-4xl text-gray-600 shadow-xl m-4 p-2 rounded-xl transition-all hover:bg-green-500 hover:text-white">
          <TiRefresh />
        </button>
      </div>
    </div>
